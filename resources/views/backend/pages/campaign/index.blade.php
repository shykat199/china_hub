                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-8 mb-2">
                            <div class="title">
                                <h4>{{__('Ecommerce Product Campaign')}}</h4>
                            </div>
                        </div>
                        <div class="col-md-4 mb-2">
                            <div class="float-md-end">
                                <a href="{{route('backend.campaign.create')}}">
                                    <button class="btn theme-btn"> {{ __('Add Campaign') }}</button>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="content-table">
                        <table id="mDataTable" class="table p-table">
                            ...
                            <tr>
                                ...
                                <th scope="col">{{ __('Landing Page Title') }}</th>
    ...
    <script>
        $(function() {
            ...
            $(document).ready(function(){
                ...
                table.DataTable({
                    ajax: "{{route('backend.campaign.list')}}",
                    columns: [
                        { data: 'id'},
                        { data: 'name' },
                        { data: 'status' },
