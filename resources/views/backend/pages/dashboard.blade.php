                            ...
                            <div class="maan-counter-wpr grid-4">
                                ...
                                <div class="maan-counter-box">
                                    <div class="maan-icon maan-radius maan-icon-clr-lightgreen">
                                        <i> <img src="{{ URL::to('backend/img/icons/pending-blue.svg') }}"
                                                alt="Icon"></i>
                                    </div>
                                    <div class="maan-desc">
                                        <div class="maan-counter">
                                            <span class="maan-counter-title timer">{{ $order_overview['1'] ?? 0 }}</span>
                                        </div>
                                ...
                                <div class="maan-counter-box">
                                    <div class="maan-icon maan-radius maan-icon-clr-lightyellow">
                                        <i> <img src="{{ URL::to('backend/img/icons/order-cancel.svg') }}"
                                                alt="Icon"></i>
                                    </div>
                                    <div class="maan-desc">
                                        <div class="maan-counter">
                                            ...
                                            @foreach ($new_customers as $key => $customer)
                                                <div class="maan-note-card-body">
                                                    <div class="dash-customar-author">
                                                        @if ($customer->image)
                                                            <img src="{{ URL::to('/frontend/img/users/' . $customer->image) }}"
                                                                alt="">
                                                        @else
                                                    ...
                                                    <div class="invoice">
                                                        <a
                                                            href="{{ route('backend.orders.show', $customer->orders->first()->id ?? '#') }}">
