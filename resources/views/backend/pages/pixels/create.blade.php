        ...
        <div class="content-body">
            <div class="container">
                <div class="content-tab-title d-flex justify-content-between align-items-center">
                    <h4>{{ __('Tag Pixels Create') }}</h4>
                    <div class="page-title-right">
                        <a href="{{ route('backend.pixels.index') }}" class="btn btn-primary text-white">
                            Manage Pages
                        </a>
                    </div>
                </div>
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="add-category" role="tabpanel"
                    ...
                    <div class="container">
                        <form action="{{route('backend.pixels.store')}}" method="POST" class=row
