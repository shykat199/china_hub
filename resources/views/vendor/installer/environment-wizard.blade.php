...
@section('title')
    <i class="fa fa-magic fa-fw" Area-hidden="true"></i>
...
@section('container')
    <div class="tabs tabs-full">
        ...
        <label for="tab1" class="tab-label">
            <i class="fa fa-cog fa-2x fa-fw" Area-hidden="true"></i>
            <br />
        ...
        <label for="tab2" class="tab-label">
            <i class="fa fa-database fa-2x fa-fw" Area-hidden="true"></i>
            <br />
        ...
        <label for="tab3" class="tab-label">
            <i class="fa fa-cogs fa-2x fa-fw" Area-hidden="true"></i>
            <br />
            ...
            <div class="tab" id="tab1content">
                ...
                <div class="buttons">
                    <button class="button" onclick="showDatabaseSettings();return false">
                        ...
                        <i class="fa fa-angle-right fa-fw" Area-hidden="true"></i>
                    </button>
                </div>
            </div>
                            ...
                            <label for="broadcast_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.broadcasting_label') }}
                                <sup>
                                    <a href="https://laravel.com/docs/5.4/broadcasting" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        <i class="fa fa-info-circle fa-fw" Area-hidden="true"></i>
