            ...
            <div class="modal-body">
                <div class="maan-modal-wraper">
                    <div class="modal-thumb">
                        <img src="<?php echo e(asset('frontend/img/image_modal.png')); ?>" alt="">
                    </div>
                    <div class="maan-modal-content">
                        <div class="content-wraper">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" Area-label="Close"></button>
                            <div class="logo"><img src="<?php echo e(asset('uploads')); ?>/<?php echo e(maanAppearance('logo')); ?>" alt=""></div>
                            <p><?php echo e(__('সকল প্রকার চাইনিজ পণ্য আমদানিকারক ও বিক্রেতা। আমাদের মাধ্যমে সরাসরি চায়না থেকে যে কোন বৈধ পণ্য আমদানি করতে পারবেন। এছাড়া আমাদের চকবাজার শপ থেকে রেডি স্টক প্রোডাক্ট খুচরা ও পাইকারি বিক্রয় সহ সারা বাংলাদেশে ক্যাশ অন হোম ডেলিভারি দেয়া হয়। ')); ?></p>
                            <div class="maan-news-letter-form">
                                <h3><?php echo e(__('Newsletter')); ?></h3>
...
<!-- Popup Ads Modal end-->
<?php /**PATH F:\xampp\htdocs\chinahub\resources\views/frontend/_popup.blade.php ENDPATH**/ ?>