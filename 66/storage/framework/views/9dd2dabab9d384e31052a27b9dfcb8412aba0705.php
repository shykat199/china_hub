    ...
    <div class="product-card-details">
        ...
        <?php else: ?>
            <?php if($product->discount > 0): ?>
                ...
                <span class=""><?php echo e(currency(($product->sale_price))); ?><del class="text-secondary"><?php echo e(currency($product->unit_price)); ?></del> <small class="text-secondary"><?php echo e(__('- ')); ?> <?php if($product->discount_type=='percentage'): ?><?php echo e($product->discount); ?><?php elseif($product->discount_type=='fixed'): ?><?php echo e(round(($product->discount/$product->unit_price) *100)); ?> <?php endif; ?><?php echo e(__('%')); ?></small></span>
            <?php else: ?>
...
<?php /**PATH F:\xampp\htdocs\chinahub\resources\views/components/frontend/product-card2.blade.php ENDPATH**/ ?>