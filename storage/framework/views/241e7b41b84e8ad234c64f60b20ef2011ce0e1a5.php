...
<?php $__env->startSection('content'); ?>
    ...
    <section class="shop-list">
        <div class="container">
            ...
            <?php echo $page->description ?? __('No content found'); ?> 
        </div>
    </section>
...
<?php echo $__env->make('frontend.layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/china_hub/resources/views/frontend/pages/blank.blade.php ENDPATH**/ ?>