...
<!-- Default -->
<link rel="stylesheet" href="{{asset('seller/css/default.css')}}">
<!-- Style -->
<link rel="stylesheet" href="{{asset('seller/css/style.css')}}">
<!-- Responsive -->
<link rel="stylesheet" href="{{asset('seller/css/responsive.css')}}">
<!-- notifications css -->
...
<!-- Font Awesome -->
<link rel="stylesheet" href="{{ asset('seller/assets/fontawesome-free-6.1.1-web/css/all.min.css') }}">
<!-- custom css -->
