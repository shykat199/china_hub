                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-group">
                                            ...
                                            <span class="label">{{ __('নাম') }} <span class="text-danger">*</span></span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="input-group">
                                            <input type="number" name="mobile">
                                            <span class="label">{{ __('মোবাইল') }} <span class="text-danger">*</span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="input-group">
                                            ...
                                            <span class="label">{{ __('ঠিকানা') }} <span class="text-danger">*</span></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 mb-4">
                                        <span class="label">{{ __('শিপিং এরিয়া') }} <span class="text-danger">*</span></span>
                                    ...
                                    <div class="col-12 text-center mb-3">
                                        <button type="submit" class="btn-anime w-50 submit-btn">{{ __('অর্ডার কনফার্ম করুন') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div style="display: flex; align-items: center; justify-content: space-between;">
                                ...
                                <div>
                                    ...
                                    <ul id="show-product" class="list-group" style="position: absolute;width: 340px;right: -63px;overflow-y: auto;height: 226px;display: none"></ul>
                                </div>
                            </div>
                            ...
                            <div class="right-form mt-2">
                                ...
                                <div class="order-cart mt-4">
                                    <ul id="order-details">
                                        <li>{{ __('Subtotal') }}<span class="sub-total" data-sub-total="{{ Cookie::get('subTotal') }}">{{ currency(Cookie::get('subTotal'), 2) }}</span></li>
