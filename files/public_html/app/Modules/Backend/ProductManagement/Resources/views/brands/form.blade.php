<div class="row">
    ...
    <div class="col-lg-7">
        <div class="input-group">
            <input id="slug" type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="@if($brand->slug){{$brand->slug}}@else{{ old('slug') }}@endif" required placeholder="Slug" autofocus>
    ...
    <div class="col-lg-7">
        <div class="input-group">
            <input id="brand_order" type="number" min="0" class="form-control @error('order') is-invalid @enderror" name="order" value="@if($brand->order){{$brand->order}}@else{{ old('order') }}@endif" placeholder="Brand Order" autofocus>
