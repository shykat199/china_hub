...
class OrderDetail extends Model
{
    ...
    protected $fillable = ['seller_id','user_id', 'courier','order_id','order_stat','product_id','color','size','sale_price','qty','discount','shipping_cost','total_shipping_cost','total_price','grand_total','tax','currency_id','exchange_rate','estimated_shipping_days','coupon_discount'];
