...
class BlogCategoryController extends Controller
{
    ...
    public function blogCategoryList(Request $request)
    {
        ...
        foreach ($records as $record) {
            ...
            $data_arr[] = array(
                ...
                "action" => '<ul>
                                <li>
                                            <a class="p-0 action" href="' . route('backend.blog.category.edit', $record->id ) . '">
                                                <button title="Edit">
                                ...
                                <li>
                                             <form user="deleteForm" method="POST"
                                                      action="' . route('backend.blog.category.destroy', $record->id) . '">
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('backend.blog.category.index')->with($this->create_success_message);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.blog.category.edit',compact('categories'));
    } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        $category->UpdateOrCreate(['id'=>$category->id],['name'=>$request->name,'slug'=>Str::slug($request->name)]);

        return redirect()->route('backend.blog.category.index')->with($this->update_success_message);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('backend.blog.category.index')->with($this->delete_success_message);
        } else {
