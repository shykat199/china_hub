<script>
    ...
    $(document).on('click', '.remove-row', function() {
        ...
        var button = $(this)
        if (productStockId) {
            var url = `http://127.0.0.1:8000/admin/variants/delete-variant/${productStockId}`
            swal({
                title: "Are you sure?",
...
<?php /**PATH D:\Works\projects\China Hub\final_update\public_html\app/Modules/Backend/ProductManagement\Resources/views/products/product-js.blade.php ENDPATH**/ ?>