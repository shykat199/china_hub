...
<div class="product-card product-shop-list-items">
    ...
    <div class="product-card-details">
        ...
        <?php if(hasPromotion($product->id)): ?>
            <span class="price"><?php echo e(currency($product->unit_price,2)); ?></span>
        <?php else: ?>
...
<?php /**PATH D:\Works\projects\China Hub\final_update\public_html\resources\views/components/frontend/product-card3.blade.php ENDPATH**/ ?>